import pic from '../photo/akkenna.png'
import pic1 from "../photo/v.png"
import pic2 from "../photo/in.png"
import pic3 from "../photo/f.png"
        ...
        <div >
            <div className="  bg-gradient-to-b from-indigo-900 from-60% via-purple-800 from-60% to-blue-900   gap-5  pt-5 ">
                <div className=" hidden lg:flex justify-center gap-[6%]  pt-3">
                    ...
                    <div>
                        <div>
                            <h2 className="text-white font-bold">Address</h2>
                            <p className="text-white text-sm">USA-New Jersey</p>

                            <p className="text-sm pt-2 text-slate-300">1040D Orchard Street, North <br /> Brunswick, New Jersey 08902</p>

                            <h2 className="text-white font-bold pt-2 ">India-Coimbatore</h2>
                    ...
                    <div>
                        <div>
                            <h2 className="text-white font-bold">Dedicated Developers</h2>
                            <ul >
